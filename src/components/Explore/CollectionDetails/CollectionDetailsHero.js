...
export default function CollectionDetailsHero({ single }) {
  const { cover, title, desc, likeCount, tags, trailer, content, creator, createdAt } = single;
  console.log(cover)
    ...
    <Box sx={{ position: 'relative' }}>
      ...
      <FooterStyle>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Avatar alt={creator} src={"https://minimal-assets-api.vercel.app/assets/images/avatars/avatar_1.jpg"} sx={{ width: 48, height: 48 }} />
          <Box sx={{ ml: 2 }}>
      ...
      {/* <OverlayStyle /> */}
      <VideoPlayer src={single.trailer} poster={single.cover} width="1280" height="720"/>
